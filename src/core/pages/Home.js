...
import { Feat1, Feat2 } from 'core/components/Featured'
import Trending from 'core/components/Trending'

import { fetchHomeRepos, askAndGo } from 'core/actions/repos'

if (process.env.BROWSER) {
  require('client/styles/Featured.scss')
  require('client/styles/Trending.scss')
}

@provideHooks({
  fetch: (({ dispatch }) => dispatch(fetchHomeRepos()))
})
@connect(
  state => ({
